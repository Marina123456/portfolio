		 ...
		 <div class="allInfo">
			 <div class="header">
				...
				<form class="search_div">
					 <input placeholder="Откуда" class="inPunct" list="listCity">
					 ...
					 <input placeholder="Куда" class="inPunct" list="listCity">
					 <input placeholder="Дата" style="width:17%;" class="searchDate">
					 <script>
						$(function(){
			 ...
			 <table class="allTable">
				<tr class="titleTr">
					 <td class="titleTable">
						...
						<div class="imgSort" onclick="img_sort(this);"></div>
					 </td>
					 <td class="titleTable" style="color:#b7b7b7">
						<span class="canNotSort">№ Пути</span>
					 </td>
					 <td class="titleTable">					 
						<span class="canSort">Отправление</span>
						<div class="imgSort" onclick="img_sort(this);"></div>
					 </td>
					 <td class="titleTable">
						 <span class="canSort">Прибытие</span>
						 <div class="imgSort" onclick="img_sort(this);"></div>
					 </td>
					 <td class="titleTable" style="color:#b7b7b7">
					...
					<td colspan="6" id="bron_<?echo $train->key_way;?>" style="display:none;">
						<form class="formBron">
							...
							<div class="inputInfo">
								...
								<input required id="inputTelephone<?echo $train->key_way;?>" placeholder="Телефон" class="inputTelephone">
								<span id="inputTelephone<?echo $train->key_way;?>ValidationMessage" class="validationMessage validFirst"></span>
								<input required type="e-mail" class="emailInp" id="inputEmail<?echo $train->key_way;?>" placeholder="E-mail">
								<span id="inputEmail<?echo $train->key_way;?>ValidationMessage" class="validationMessage validFirst"></span>
								<div class="clearAll"></div>
								
								<br>
								<div class="fioInp">
									<input required class="fioF"  id="inputFam<?echo $train->key_way;?>" placeholder="Фамилия">
									<input required class="fioN"  id="inputName<?echo $train->key_way;?>" placeholder="Имя" >
									<input required class="fioOt" id="inputOt<?echo $train->key_way;?>" placeholder="Отчество">
									<input required class="dataRogd" id="inputDataRogd<?echo $train->key_way;?>" placeholder="Дата рождения" style="margin-left: 39px;  width: 18%;">
									<div class="polInp">
										<input id="polМen" type="radio" name="pol" class="chekInp">
										<label for="polМen">М</label>
										<input checked id="polFem" type="radio" name="pol" class="chekInp">
										<label for="polFem">Ж</label>
									</div>	
								...
								<div class="pasportInfo">
									<input required class="grazhd" id="inputGrazh<?echo $train->key_way;?>" placeholder="Гражданство">
									<input required class="seriaPas notLeft" id="inputSeriaPas<?echo $train->key_way;?>" placeholder="Серия и № документа">
									<input required class="deistvie notLeft" id="inputDeistvie<?echo $train->key_way;?>" placeholder="Действует до" style="width: 26%;">
									<div class="clearAll"></div>
